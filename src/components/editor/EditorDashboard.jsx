  ...
  return (
    <section className=' md:absolute md:top-14 md:-left-6 lg:left-0 md:w-[55%] lg:w-[55%]  mx-1 md:py-4 md:mx-48 lg:mx-64 md:text-xl'>
      ...
      <ul className='flex flex-col  border text-center text-violet-800 text-lg'>
        <Link className='border-b-2 py-3 md:py-5 hover:bg-indigo-100' to="/post/editor/video/category">Videos</Link>
        <Link className='border-b-2 py-3 md:py-5 hover:bg-indigo-100' to="/post/editor/lyric/category">Lyrics</Link>
        <Link className='border-b-2 py-3 md:py-5 hover:bg-indigo-100' to="/post/editor/album">Albums</Link>
